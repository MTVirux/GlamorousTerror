...
public sealed class BonusItemCombo(FavoriteManager favorites, ItemManager items, Configuration config, IDataManager gameData, BonusItemFlag slot, ItemNameService itemNameService, ItemUnlockManager itemUnlockManager)
